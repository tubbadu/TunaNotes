...
QT_MOC_LITERAL(4, 27, 5), // "write"
QT_MOC_LITERAL(5, 33, 11), // "filecontent"
QT_MOC_LITERAL(6, 45, 8) // "getProva"

    },
    "FileManager\0read\0\0filename\0write\0"
    "filecontent\0getProva"
};
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->write((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: { QString _r = _t->getProva();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
